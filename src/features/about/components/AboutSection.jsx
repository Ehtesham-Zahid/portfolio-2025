    ...
    >
      <div className="w-11/12 2xl:w-5/6 mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="max-w-2xl">
          <p className="text-sm tracking-wide text-primary-light dark:text-primary-dark mb-3">
            About me
          </p>
          ...
          <p className="mt-4 text-text2-light dark:text-text1-dark/80">
        ...
        <div className="mt-12 grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 grid sm:grid-cols-2 gap-6">
            {highlights.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="group rounded-2xl p-[1px] bg-gradient-to-tr from-primary-light/30 to-transparent dark:from-primary-dark/30"
              >
                <div className="rounded-2xl h-full border border-secondary-light dark:border-secondary-dark bg-background-light/70 dark:bg-background-dark/60 backdrop-blur-sm p-5 transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:shadow-sm">
                  <div className="flex items-start gap-3">
                    <div className="h-10 w-10 rounded-xl grid place-items-center bg-primary-light/12 dark:bg-primary-dark/12 text-primary-light dark:text-primary-dark ring-1 ring-primary-light/20 dark:ring-primary-dark/20">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-sm text-text2-light dark:text-text1-dark/70">
                        {desc}
                      </p>
                    </div>
                  </div>
          ...
          <div className="lg:col-span-1">
            <div className="rounded-2xl border border-secondary-light dark:border-secondary-dark bg-background-light/70 dark:bg-background-dark/60 backdrop-blur-sm p-6">
              <h3 className="text-base font-semibold text-text1-light dark:text-text1-dark">
                Journey
              </h3>
